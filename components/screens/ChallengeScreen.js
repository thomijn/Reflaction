...
import kitchen from '../../assets/images/Open-Keuken.jpg';
...
const ChallengeScreen = ({
  ...
  Radar.on('events', (result) => {
    if (
      ...
      challenge.name === 'Wandel met House of Hope' &&
      active
    ) {
  ...
  return (
    <>
      <Container
        background="#fff"
        style={{padding: 20, height: '100%', flex: 1}}>
        ...
        <Text color={'#2B2D42'} style={{opacity: 0.6, fontStyle: 'italic'}}>
          Hoe verdien jij punten met deze challenge?{' '}
        </Text>
        <Text
          style={{marginBottom: 20, fontSize: 18, lineHeight: 25}}
          color={'#2B2D42'}>
        ...
        {challenge.name === 'Wandel met House of Hope' && active && (
          <View
            style={{
              alignItems: 'center',
              height: 250,
        ...
        {!active && challenge.name === 'Wandel met House of Hope' && (
          <View
            style={{
              bottom: 20,
              left: 20,
          ...
          <>
            ...
            <View
              ...
              <Card style={{backgroundColor: theme.colors.orange}}>
                ...
                <CardItem>
                  <Body>
                    <Text color="#000">{selectedLanguage.succes}</Text>
                  </Body>
                </CardItem>
                <CardItem footer button>
                  <Text color="#000">
                    {earn} <Text color={theme.colors.orange}>100</Text> {points}
                  </Text>
                </CardItem>
              </Card>
            </View>
